...
class ClientConnectionManager(object):
    ...
    def get_by_name(self, name):
        return self._client_connections_by_name.get(
            name,
            None
        )
    ...
    def remove(self, client_connection):
        if client_connection:
            ...
            if (
                location in self._client_connections_by_location and
    ...
    def _on_client_connection_location_change(self, client_connection, old_location, new_location):
        client_connection_id = client_connection.id
        old_client_connections_by_client_connection_id = self._client_connections_by_location.get(
            old_location,
            {}
        )
        if client_connection_id in old_client_connections_by_client_connection_id:
            ...
            self._client_connections_by_location[old_location] = old_client_connections_by_client_connection_id
        new_client_connections_by_client_connection_id = self._client_connections_by_location.get(new_location, {})
        if not client_connection_id in new_client_connections_by_client_connection_id:
            ...
            self._client_connections_by_location[new_location] = new_client_connections_by_client_connection_id

    def _on_client_connection_name_change(self, client_connection, old_name, new_name):
